...
* Version 8.9.0 - 24 Mar 2026
    ...
    * Notes for updating:
        * Update ApiCredentials to HTXCredentials for authentication, i.e. `ApiCredentials = new ApiCredentials(..)` => `ApiCredentials = new HTXCredentials(..)`
        * When using AddHTX with the Configuration overload (loading config from appsettings), the API credentials path has been changed from ApiCredentials:Key to ApiCredentials:HMAC:Key (and secret)

* Version 8.8.0 - 06 Mar 2026
