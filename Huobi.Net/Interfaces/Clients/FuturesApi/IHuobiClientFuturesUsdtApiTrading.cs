...
namespace Huobi.Net.Interfaces.Clients.FuturesApi
{
    ...
    public interface IHuobiClientFuturesUsdtApiTrading
    {
        ...
        /// <returns></returns>
        Task<WebCallResult<HuobiFuturesTradeResponse>> GetUserTradesAsync(string contractCode, TradeType? tradeType = null, int daysLookback = 90, int? page = null, int? limit = null, CancellationToken ct = default);
    }
}
