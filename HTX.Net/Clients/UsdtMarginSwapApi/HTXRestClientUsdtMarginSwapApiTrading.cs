...
namespace HTX.Net.Clients.UsdtMarginSwapApi
{
    ...
    internal class HTXRestClientUsdtMarginSwapApiTrading : IHTXRestClientUsdtMarginSwapApiTrading
    {
        ...
        public async Task<WebCallResult<IEnumerable<HTXCrossMarginOrder>>> GetCrossMarginClosedOrdersAsync(string contractCode, MarginTradeType tradeType, string? pair = null, bool? allOrders = null, IEnumerable<OrderStatusFilter>? status = null, DateTime? startTime = null, DateTime? endTime = null, FilterDirection? direction = null, long? fromId = null, CancellationToken ct = default)
        {
            ...
            var request = _definitions.GetOrCreate(HttpMethod.Post, "/linear-swap-api/v3/swap_cross_hisorders", HTXExchange.RateLimiter.EndpointLimit, 1, true);
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<IEnumerable<HTXIsolatedMarginUserTrade>>> GetIsolatedMarginUserTradesAsync(string contractCode, MarginTradeType tradeType, string? pair = null, DateTime? startTime = null, DateTime? endTime = null, FilterDirection? filterDirection = null, long? fromId = null, CancellationToken ct = default)
        {
            var parameters = new ParameterCollection();
            parameters.Add("contract", contractCode);
            ...
            parameters.AddOptional("from_id", fromId);
            var request = _definitions.GetOrCreate(HttpMethod.Post, "/linear-swap-api/v3/swap_matchresults", HTXExchange.RateLimiter.EndpointLimit, 1, true);
            var result = await _baseClient.SendAsync<IEnumerable<HTXIsolatedMarginUserTrade>>(request, parameters, ct).ConfigureAwait(false);
            return result;
        }
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<IEnumerable<HTXCrossMarginUserTrade>>> GetCrossMarginUserTradesAsync(string contractCode, MarginTradeType tradeType, string? pair = null, DateTime? startTime = null, DateTime? endTime = null, FilterDirection? filterDirection = null, long? fromId = null, CancellationToken ct = default)
        {
            var parameters = new ParameterCollection();
            parameters.Add("contract", contractCode);
            parameters.AddEnum("trade_type", tradeType);
            ...
            parameters.AddOptionalEnum("direct", filterDirection);
            parameters.AddOptional("from_id", fromId);
            var request = _definitions.GetOrCreate(HttpMethod.Post, "/linear-swap-api/v3/swap_cross_matchresults ", HTXExchange.RateLimiter.EndpointLimit, 1, true);
            var result = await _baseClient.SendAsync<IEnumerable<HTXCrossMarginUserTrade>>(request, parameters, ct).ConfigureAwait(false);
            return result;
        }
        ...
        public async Task<WebCallResult<HTXClosePositionResult>> CloseCrossMarginPositionAsync(OrderSide direction, string? contractCode = null, string? pair = null, ContractType? contractType = null, long? clientOrderId = null, LightningPriceType? orderPriceType = null, CancellationToken ct = default)
        {
            ...
            parameters.AddOptional("client_order_id", clientOrderId);
            parameters.AddOptionalEnum("order_price_type", orderPriceType);
            var request = _definitions.GetOrCreate(HttpMethod.Post, "/linear-swap-api/v1/swap_cross_lightning_close_position ", HTXExchange.RateLimiter.EndpointLimit, 1, true);
            var result = await _baseClient.SendBasicAsync<HTXClosePositionResult>(request, parameters, ct).ConfigureAwait(false);
            return result;
        }
        ...
        public async Task<WebCallResult<HTXOrderIds>> PlaceCrossMarginTrailingOrderAsync(OrderSide side, Offset offset, int leverageRate, decimal quantity, decimal callbackRate, decimal activePrice, OrderPriceType orderPriceType, string? contractCode = null, string? pair = null, ContractType? contractType = null, bool? reduceOnly = null, CancellationToken ct = default)
        {
            ...
            parameters.Add("active_price", activePrice);
            parameters.AddEnum("order_price_type", orderPriceType);
            var request = _definitions.GetOrCreate(HttpMethod.Post, "linear-swap-api/v1/swap_cross_track_order", HTXExchange.RateLimiter.EndpointLimit, 1, true);
            var result = await _baseClient.SendBasicAsync<HTXOrderIds>(request, parameters, ct).ConfigureAwait(false);
            return result;
        }
