...
namespace HTX.Net
{
    internal static class HTXErrorMapping
    {
        internal static ErrorCollection SpotMapping { get; } = new ErrorCollection([
                ...
                new ErrorInfo(ErrorType.SignatureInvalid, false, "Invalid signature", "1003"),
                ...
                new ErrorInfo(ErrorType.QuantityInvalid, false, "Quantity more than max quantity", "order-amount-over-limit", "order-limitorder-amount-max-error", "3005", "3010"),
                new ErrorInfo(ErrorType.QuantityInvalid, false, "Quantity less than min quantity", "order-limitorder-amount-min-error", "order-marketorder-amount-min-error", "3004", "3009"),
                new ErrorInfo(ErrorType.QuantityInvalid, false, "Quantity decimal precision invalid", "order-orderamount-precision-error", "3002"),
                new ErrorInfo(ErrorType.QuantityInvalid, false, "Order value too low", "order-value-min-error", "3008"),
                new ErrorInfo(ErrorType.QuantityInvalid, false, "Order value too high", "order-marketorder-amount-buy-max-error", "order-marketorder-amount-sell-max-error"),

                new ErrorInfo(ErrorType.PriceInvalid, false, "Price deviates too much from the last price", "order-invalid-price"),
                new ErrorInfo(ErrorType.PriceInvalid, false, "Price too low", "order-limitorder-price-min-error", "order-price-greater-than-limit", "3007"),
                new ErrorInfo(ErrorType.PriceInvalid, false, "Price too high", "order-limitorder-price-max-error", "order-price-less-than-limit", "3006"),
                new ErrorInfo(ErrorType.PriceInvalid, false, "Price decimal precision invalid", "order-orderprice-precision-error"),
                new ErrorInfo(ErrorType.PriceInvalid, false, "The price exceeds the protective price during limit-price trading", "price-exceeds-the-protective-price-during-limit-price-trading"),

                new ErrorInfo(ErrorType.DuplicateClientOrderId, false, "Duplicate client order id", "invalid-client-order-id"),

                new ErrorInfo(ErrorType.BalanceInsufficient, false, "Insufficient balance", "order-accountbalance-error"),

                new ErrorInfo(ErrorType.RequestRateLimited, false, "Too many requests", "40403", "510", "1006"),

                new ErrorInfo(ErrorType.UnknownOrder, false, "Order not found", "not-found"),

                new ErrorInfo(ErrorType.SymbolNotTrading, false, "Order not allowed during protection phase", "forbidden-trade-for-open-protect"),
                new ErrorInfo(ErrorType.SymbolNotTrading, false, "Symbol not trading", "base-symbol-trade-disabled", "2003"),

                new ErrorInfo(ErrorType.TargetIncorrectState, false, "Order state invalid", "order-orderstate-error"),

                new ErrorInfo(ErrorType.OrderConfigurationRejected, false, "The symbol is pending and not allowed to place order", "order-disabled"),
                new ErrorInfo(ErrorType.OrderConfigurationRejected, false, "The symbol is pending and not allowed to cancel order", "cancel-disabled"),
                new ErrorInfo(ErrorType.OrderConfigurationRejected, false, "Stop order would trigger immediately", "order-stop-order-hit-trigger"),
                new ErrorInfo(ErrorType.OrderConfigurationRejected, false, "Market orders not supported during limit price trading", "market-orders-not-support-during-limit-price-trading", "3100"),
            ...
            [
                ...
                new ErrorEvaluator("invalid-parameter", (code, msg) => {
                    ...
                    if (msg.Equals("invalid size"))
                        return new ErrorInfo(ErrorType.QuantityInvalid, false, "Invalid quantity", code);
                ...
                new ErrorEvaluator("bad-request", (code, msg) => {
                    ...
                    if (msg.Equals("symbol trade not open now"))
                        return new ErrorInfo(ErrorType.SymbolNotTrading, false, "Symbol not currently trading", code);

                    if (msg.Equals("429 too many request"))
                        return new ErrorInfo(ErrorType.RequestRateLimited, true, "Too many requests", code);
                ...
                new ErrorEvaluator("4000", (code, msg) => {
                    ...
                    if (msg.Equals("too.many.connection"))
                        return new ErrorInfo(ErrorType.ConnectionRateLimited, false, "Too many connections", code);
        ...
        internal static ErrorCollection FuturesMapping { get; } = new ErrorCollection([
                ...
                new ErrorInfo(ErrorType.SignatureInvalid, true, "Signature verification failed", "1253"),
                ...
                new ErrorInfo(ErrorType.QuantityInvalid, false, "Invalid quantity", "1040"),
                new ErrorInfo(ErrorType.QuantityInvalid, false, "Quantity should be more than 0", "1322"),
                new ErrorInfo(ErrorType.QuantityInvalid, false, "Quantity exceeds max order quantity", "1041"),
                new ErrorInfo(ErrorType.QuantityInvalid, false, "Reduce only quantity exceeds open position quantity", "1492"),

                new ErrorInfo(ErrorType.PriceInvalid, false, "Price decimal precision invalid", "1038", "1412"),
                new ErrorInfo(ErrorType.PriceInvalid, false, "Price deviates too much from current price", "1039"),
                new ErrorInfo(ErrorType.PriceInvalid, false, "Invalid price", "1055", "1069", "1075"),
                new ErrorInfo(ErrorType.PriceInvalid, false, "Price too high", "1072"),

                new ErrorInfo(ErrorType.BalanceInsufficient, false, "Insufficient quantity available", "1301"),
                new ErrorInfo(ErrorType.BalanceInsufficient, false, "Insufficient margin available", "1047"),
                new ErrorInfo(ErrorType.BalanceInsufficient, false, "Insufficient close quantity available", "1048"),

                new ErrorInfo(ErrorType.SymbolNotTrading, false, "Symbol not currently trading", "1057", "1058"),

                new ErrorInfo(ErrorType.OrderConfigurationRejected, false, "Symbol in settlement, can't place or cancel orders", "1056"),
                new ErrorInfo(ErrorType.OrderConfigurationRejected, false, "Symbol in delivery, can't place or cancel orders", "1059"),

                new ErrorInfo(ErrorType.TargetIncorrectState, false, "Order has been canceled", "1063", "1071"),
                new ErrorInfo(ErrorType.TargetIncorrectState, false, "Position is in forced liquidation", "1083"),

                new ErrorInfo(ErrorType.RequestRateLimited, false, "Too many requests", "1032"),
                new ErrorInfo(ErrorType.OrderRateLimited, false, "Too many TP/SL orders", "1403"),
            ]);
