...
namespace HTX.Net.Interfaces.Clients.UsdtFuturesApi
{
    ...
    public interface IHTXRestClientUsdtFuturesApiSubAccount
    {
        ...
        /// <returns></returns>
        Task<HttpResult<HTXIsolatedMarginSubAccountAssets[]>> GetCrossMarginAssetsAsync(string? marginAccount = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<HttpResult<HTXIsolatedMarginSubAccountAssets[]>> GetIsolatedMarginAssetsAsync(string? contractCode = null, CancellationToken ct = default);
        /// <summary>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<HttpResult<HTXMasterSubTransferPage>> GetMasterSubTransferRecordsAsync(string marginAccount, int daysInHistory, MasterSubTransferType? type = null, int? page = null, int? pageSize = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<HttpResult<HTXSubAccountResult>> SetTradingPermissionsAsync(IEnumerable<string> subAccountUids, bool enabled, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<HttpResult<HTXSwapOrderId>> TransferMasterSubAsync(string subUid, string asset, string fromMarginAccount, string toMarginAccount, decimal quantity, MasterSubTransferType type, long? clientOrderId = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        Task<HttpResult<HTXSubTradePermissions>> GetTradePermissionsAsync(IEnumerable<string>? subAccountUids = null, DateTime? startTime = null, DateTime? endTime = null, FilterDirection? filterDirection = null, long? fromId = null, CancellationToken ct = default);
        ...
        /// <param name="pageSize">["<c>page_size</c>"] Page size</param>
        /// <param name="ct">Cancellation token</param>
        Task<HttpResult<HTXSubAccountAssetInfoPage>> GetIsolatedMarginAssetInfoAsync(string? contractCode = null, int? page = null, int? pageSize = null, CancellationToken ct = default);
        ...
        /// <param name="pageSize">["<c>page_size</c>"] Page size</param>
        /// <param name="ct">Cancellation token</param>
        Task<HttpResult<HTXSubAccountCrossAssetInfoPage>> GetCrossMarginAssetInfoAsync(string? marginAccount = null, int? page = null, int? pageSize = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        Task<HttpResult<HTXPosition[]>> GetIsolatedMarginPositionsAsync(long subUserId, string? contractCode = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        Task<HttpResult<HTXCrossPosition[]>> GetCrossMarginPositionsAsync(long subUserId, string? contractCode = null, string? pair = null, ContractType? contractType = null, CancellationToken ct = default);
