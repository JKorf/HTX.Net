...
namespace HTX.Net.Interfaces.Clients.SpotApi
{
    ...
    public interface IHTXSocketClientSpotApi : ISocketApiClient<HTXCredentials>, IDisposable
    {
        ...
        /// </summary>
        public IHTXSocketClientSpotSharedApi SharedApi { get; }
        ...
        /// <returns></returns>
        Task<QueryResult<HTXKline[]>> GetKlinesAsync(string symbol, KlineInterval period);
        ...
        Task<WebSocketResult<UpdateSubscription>> SubscribeToKlineUpdatesAsync(string symbol, KlineInterval period, Action<DataEvent<HTXKline>> onData, CancellationToken ct = default);
        ...
        /// <returns></returns>
        Task<QueryResult<HTXOrderBook>> GetOrderBookWithMergeStepAsync(string symbol, int mergeStep);
        ...
        /// <returns></returns>
        Task<QueryResult<HTXIncementalOrderBook>> GetOrderBookAsync(string symbol, int levels);
        ...
        /// <param name="ct">Cancellation token for closing this subscription</param>
        /// <returns>A stream subscription. This stream subscription can be used to be notified when the socket is disconnected/reconnected</returns>
        Task<WebSocketResult<UpdateSubscription>> SubscribeToPartialOrderBookUpdates100MillisecondAsync(string symbol, int levels, Action<DataEvent<HTXOrderBook>> onData, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token for closing this subscription</param>
        /// <returns>A stream subscription. This stream subscription can be used to be notified when the socket is disconnected/reconnected</returns>
        Task<WebSocketResult<UpdateSubscription>> SubscribeToPartialOrderBookUpdates1SecondAsync(string symbol, int mergeStep, Action<DataEvent<HTXOrderBook>> onData, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token for closing this subscription</param>
        /// <returns>A stream subscription. This stream subscription can be used to be notified when the socket is disconnected/reconnected</returns>
        Task<WebSocketResult<UpdateSubscription>> SubscribeToOrderBookChangeUpdatesAsync(string symbol, int levels, Action<DataEvent<HTXIncementalOrderBook>> onData, CancellationToken ct = default);
        ...
        /// <returns></returns>
        Task<QueryResult<HTXSymbolTradeDetails[]>> GetTradeHistoryAsync(string symbol);
        ...
        /// <param name="ct">Cancellation token for closing this subscription</param>
        /// <returns>A stream subscription. This stream subscription can be used to be notified when the socket is disconnected/reconnected</returns>
        Task<WebSocketResult<UpdateSubscription>> SubscribeToTradeUpdatesAsync(string symbol, Action<DataEvent<HTXSymbolTrade>> onData, CancellationToken ct = default);
        ...
        /// <returns></returns>
        Task<QueryResult<HTXSymbolDetails>> GetSymbolDetailsAsync(string symbol);
        ...
        /// <param name="ct">Cancellation token for closing this subscription</param>
        /// <returns>A stream subscription. This stream subscription can be used to be notified when the socket is disconnected/reconnected</returns>
        Task<WebSocketResult<UpdateSubscription>> SubscribeToSymbolDetailUpdatesAsync(string symbol, Action<DataEvent<HTXSymbolDetails>> onData, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token for closing this subscription</param>
        /// <returns>A stream subscription. This stream subscription can be used to be notified when the socket is disconnected/reconnected</returns>
        Task<WebSocketResult<UpdateSubscription>> SubscribeToTickerUpdatesAsync(string symbol, Action<DataEvent<HTXSymbolTick>> onData, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token for closing this subscription</param>
        /// <returns>A stream subscription. This stream subscription can be used to be notified when the socket is disconnected/reconnected</returns>
        Task<WebSocketResult<UpdateSubscription>> SubscribeToTickerUpdatesAsync(Action<DataEvent<HTXSymbolTicker[]>> onData, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token for closing this subscription</param>
        /// <returns>A stream subscription. This stream subscription can be used to be notified when the socket is disconnected/reconnected</returns>
        Task<WebSocketResult<UpdateSubscription>> SubscribeToBookTickerUpdatesAsync(string symbol, Action<DataEvent<HTXBestOffer>> onData, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token for closing this subscription</param>
        /// <returns>A stream subscription. This stream subscription can be used to be notified when the socket is disconnected/reconnected</returns>
        Task<WebSocketResult<UpdateSubscription>> SubscribeToAccountUpdatesAsync(Action<DataEvent<HTXAccountUpdate>> onAccountUpdate, int? updateMode = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token for closing this subscription</param>
        /// <returns>A stream subscription. This stream subscription can be used to be notified when the socket is disconnected/reconnected</returns>
        Task<WebSocketResult<UpdateSubscription>> SubscribeToOrderDetailsUpdatesAsync(string? symbol = null,
        ...
        Task<QueryResult<string>> PlaceOrderAsync(
            long accountId,
            string symbol,
        ...
        /// <param name="ct"></param>
        /// <returns></returns>
        Task<QueryResult<CallResult<HTXBatchPlaceResult>[]>> PlaceMultipleOrdersAsync(
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<QueryResult<HTXOrderId>> PlaceMarginOrderAsync(
            long accountId,
            string symbol,
            Enums.OrderSide side,
            Enums.OrderType type,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<QueryResult<HTXByCriteriaCancelResult>> CancelAllOrdersAsync(
           long accountId,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<QueryResult> CancelOrderAsync(string? orderId = null, string? clientOrderId = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<QueryResult<HTXBatchCancelResult>> CancelOrdersAsync(
