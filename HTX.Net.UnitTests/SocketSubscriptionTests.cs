...
namespace HTX.Net.UnitTests
{
    ...
    public class SocketSubscriptionTests
    {
        ...
        public async Task ValidateUsdtMarginSwapSubscriptions()
        {
            ...
            await tester.ValidateAsync<HTXSymbolTickUpdate>((client, handler) => client.UsdtFuturesApi.SubscribeToSymbolTickerUpdatesAsync("ETH-USDT", handler), "Ticker", nestedJsonProperty: "tick");
            ...
            await tester.ValidateAsync<IEnumerable<HTXUsdtMarginSwapFundingRateUpdate>>((client, handler) => client.UsdtFuturesApi.SubscribeToFundingRateUpdatesAsync(handler), "Funding", nestedJsonProperty: "data");
            await tester.ValidateAsync<IEnumerable<HTXUsdtMarginSwapContractUpdate>>((client, handler) => client.UsdtFuturesApi.SubscribeToContractUpdatesAsync(handler), "Contract", nestedJsonProperty: "data");
            await tester.ValidateAsync<IEnumerable<HTXUsdtMarginSwapContractElementsUpdate>>((client, handler) => client.UsdtFuturesApi.SubscribeToContractElementsUpdatesAsync(handler), "ContractElements", nestedJsonProperty: "data");
